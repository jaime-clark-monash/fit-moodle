...
function ActivateHelp() {
  ...
  if (Editormode.checked) {
    ...
    document.body.appendChild(button);
    document.body.appendChild(document.getElementById('helpPopup'));
